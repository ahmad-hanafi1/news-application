...
const SearchReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case actionTypes.SET_API_VALUE:
            return {...state, API: `https://newsapi.org/v2/everything?q=${action.payload.countryValue} AND ${action.payload.categoryValue}&apiKey=c9f379fbce584d1bbb780ff3f3fea407&language=en`}
        ...
        case actionTypes.SET_API_VALUE_SEARCH:
            return {...state, API: `https://newsapi.org/v2/everything?q=${action.payload.searchValue}&apiKey=c9f379fbce584d1bbb780ff3f3fea407&language=en`}
