...
const SearchReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case actionTypes.SET_API_VALUE:
            return {...state, API: `https://newsapi.org/v2/everything?q=${action.payload.countryValue}%20${action.payload.categoryValue}&apiKey=e1b9d1fd041645a1aeb497405363fe97&language=en`}
